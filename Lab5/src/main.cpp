...
//zmiana wartosci macierzy testowych //
#define WARTOSCI_MACIERZY_1 5
#define WARTOSCI_MACIERZY_2 7
...
int main(int argc, char *argv[])
{
    ...
    for(int i = 1; i <= kolumny; i++)
    {
        for(int j = 1; j <= kolumny; j++)
        {
            mnozona.set( i, j, WARTOSCI_MACIERZY_2);
            kwadrat.set( i, j, WARTOSCI_MACIERZY_1);
        }
    }
    cout << endl << "Macierz nr1:" << endl;
    kwadrat.print();
    cout << endl << "Macierz nr2:" << endl;
    mnozona.print();

    //test operatora+//
    cout << endl << "test operatora+ :" << endl;
    przyklad = mnozona+kwadrat;
    przyklad.print();
    ...
    //test operatora[]//
     cout << endl << "test operatora[] (dla kolumny 1 z wymnozonej macierzy) :" << endl;
    int n = przyklad.cols();
    double* tab = przyklad[1];
    ...
    //test operatora==//
     cout << endl << "test operatora== (porownanie macierzy nr1 i macierzy nr2):" << endl;
    if(mnozona==kwadrat)
        cout << "sa rowne" << endl;
    else
        cout << "sa rozne" << endl;
